...
(function ($) {
    $.fn.foxibox = function (settings) {
        ...
        $(settings.bg_curtain).append(foxibox_objects);
        ...
        function open(element) {
            ...
            }).hide().bind('click', function () { close(); });
        ...
        function showImage(element) {
            ...
            preload_img.onload = function () {
                ...
                var details_height = $('#foxibox_details').outerHeight();
                ...
                if (!scaled && settings.scale) {
                    ...
                    if (scaled) {
                        // correct details
                        $('#foxibox_details').css('width', preload_width);
                        details_height = $('#foxibox_details').outerHeight();
                ...
                if (settings.bg_curtain != "body") {
                    if (container_height > bg_div_height) {
                        container_height = bg_div_height - settings.border * 2 - details_height// - details_height;
                        details_top = container_top + container_height + settings.border * 2;
                        details_left = details_left - settings.border;
                        $('#foxibox_details').css({ 'width': $('#foxibox_details').width() + settings.border * 2 });
                    }
                    else {
                        details_top = container_top + container_height - details_height + settings.border;
                    }
                    // container_width = bg_div_width;
        ...
        function getSize() {
            ...
            if (settings.bg_curtain != "body") {
                bg_div_width = $(settings.bg_curtain).width();
                bg_div_height = $(settings.bg_curtain).height();


                window_width = bg_div_width;
                window_height = bg_div_height;
                document_width = bg_div_width;
                document_height = bg_div_height;
            }
        }
    }
})(jQuery);